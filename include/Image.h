...
{
public:
    Image(unsigned int lvl_id, const std::string& path, const glm::vec3& start_positions, float xz_scaling, float y_scaling);
    ~Image();
    ...
    void init(const std::unordered_map<int, GLTexture>& textures, const std::vector<Image>& levels, const glm::vec3& cam_pos,
