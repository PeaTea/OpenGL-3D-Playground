...
void LevelData::init(const int& lvl_id, const std::unordered_map<int, GLTexture>& textures, const std::vector<Level>& levels, const glm::vec3& cam_pos,
...
void LevelData::update_and_render(const glm::vec3& cam_pos, const int& cf_height)
{
